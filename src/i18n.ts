...
const systemLocale = () => ( Platform.OS === 'ios' ? ( NativeModules.SettingsManager.settings?.AppleLocale || NativeModules.SettingsManager.getConstants()?.settings?.AppleLocale || NativeModules.SettingsManager.settings?.AppleLanguages[0] || NativeModules.SettingsManager.getConstants()?.settings?.AppleLanguages[0] ) : NativeModules.I18nManager.localeIdentifier  || NativeModules.I18nManager.getConstants()?.localeIdentifier ) || 'en';
